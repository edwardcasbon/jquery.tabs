...
$thisTab.css({'filter':'alpha(opacity=0)','zoom':'1','opacity':'0'});$thisTab.show(); if(settings.onTabChange&&typeof settings.onTabChange==='function'){settings.onTabChange.call();} 
